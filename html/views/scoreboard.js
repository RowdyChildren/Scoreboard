...
function setupTeams() {
  ...
  $.each( [ "1", "2" ], function() {
    ...
    var officialReviewsName = $("<div><a>Bonus</a></div>").addClass("Team"+team+" Name TextContainer").appendTo("#OfficialReviews");
...
//FIXME - should be using class instead of global id attr
  ...
  $("#Lineup>div.Name>a>span.Name").replaceWith($("<span>").addClass("Name").text("Break"));
